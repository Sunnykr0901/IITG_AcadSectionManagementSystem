	...
	private: System::Void StudentNoticifications_Load(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 void generateNotcfButtons(){
				 ...
				 {				
					 ...
					 String ^ aString = "Select * from Notification where [OtherReceivers] ='"+usrnm+"' OR ([Type] = 'Message' AND [Session] = '"+session+"' AND [Semester] = '"+semesterName+"' AND [Programme] = '"+studentProgramme+"' AND [DeptID] = '"+studentDeptID+"') ORDER BY SendDate";
