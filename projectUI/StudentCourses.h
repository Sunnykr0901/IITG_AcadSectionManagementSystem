...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(644, 11);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(17, 23);
			...
			this->pictureBox2->Location = System::Drawing::Point(591, 55);
...
#pragma endregion
		...
		void generateCourseButtons(){
			...
			label1->Location = System::Drawing::Point(150, 21);
			...
			dropChangeLbl->Location = System::Drawing::Point(437, 413);
		...
		void generate_prev_btn(){
			...
			prev_btn->BackgroundImage = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"pictureBox1.BackgroundImage")));
		...
		void generate_next_btn(){
			...
			next_btn->BackgroundImage = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"pictureBox2.BackgroundImage")));
